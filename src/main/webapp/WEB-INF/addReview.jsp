...
<title><c:out value="Add a Review!"/></title>
<!-- Bootstrap CSS -->
...
<body>
	...
	<div class="form-body">
		<div class="title">
			<h2 class="title-text"><c:out value="Adding new review!"/></h2>
		</div>
		<div class="edit">
			...
			<form action="/dashboard" method="GET"><input type="submit" value="Cancel"/></form>
		</div>
	</div>
</body>
</html>
